...
const handleDelete = (id) => {
  ...
  return (
    ...
    <div className={styles.flexHeadButt}>
    <div>
    <h3 className={styles.listTitle}>Recent Trips </h3>
    </div>
    <div>
    <NavLink to="/company/AddTrip/2" exact>
    <button className={styles.userAddButton}>Add trip</button>
    </NavLink>
